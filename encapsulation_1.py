"""
:testcase_name 01-encapsulation-1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/01-encapsulation-1.py
:description Encapsulation means to preserve data in classes using methods
