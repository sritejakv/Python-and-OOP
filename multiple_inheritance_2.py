"""
:testcase_name multiple_inheritance_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/15-multiple-inheritance-2.py
:description Python supports multiple inheritance
