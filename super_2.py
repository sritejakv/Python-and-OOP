"""
:testcase_name super_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/41-super-2.py
:description For more information on how this works, refer:
