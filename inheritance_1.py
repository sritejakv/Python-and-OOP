"""
:testcase_name inheritance_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/09-inheritance-1.py
:description The code below shows how a class can inherit from another class.
