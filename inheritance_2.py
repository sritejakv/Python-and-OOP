"""
:testcase_name inheritance_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/10-inheritance-2.py
:description The code below shows another example of inheritance
