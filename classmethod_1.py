"""
:testcase_name classmethod_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/27-classmethod-1.py
:description A classmethod is an inbuilt decorator which is called on functions via
@classmethod.
...
NOTE : For the class MyClass: MyClass is the class itself, MyClass() is an instance
"""
