"""
:testcase_name class_attributes_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/06-class-attributes-1.py
:description Here we define an attribute under the class `YourClass`
