"""
:testcase_name class_attributes_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/06-class-attributes-2.py
:description The code below shows two important points:
