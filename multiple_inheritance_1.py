"""
:testcase_name multiple_inheritance_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/14-multiple-inheritance-1.py
:description Python supports multiple inheritance and uses a depth-first order
