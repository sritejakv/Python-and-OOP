"""
:testcase_name polymorphism_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/12-polymorphism-2.py
:description Another example for Polymorphism are the several inbuilt
