"""
:testcase_name decorators_4.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/22-decorators-4.py
:description Reference: Decorators 101 - A Gentle Introduction to Functional Programming.
