"""
:testcase_name class_instance_attributes_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/08-class-instance-attributes-1.py
:description This code shows that an Instance can access it's own
