"""
:testcase_name abstractclasses_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/35-abstractclasses-2.py
:description This code snippet talks about Abstract Base Classes (abc).
