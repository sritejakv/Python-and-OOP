"""
:testcase_name instance_methods_2.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/18-instance_methods-2.py
:description Instance methods are the normal way of accessing methods, seen in all
