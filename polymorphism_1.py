"""
:testcase_name polymorphism_1.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/11-polymorphism-1.py
:description Polymorphism means having the same interface/attributes in different
classes.
