"""
:testcase_name encapsulation_3.py
:source https://github.com/arvimal/Python-and-OOP/blob/master/03-encapsulation-3.py
:description Here we look at another example, where we have three methods
